    ...
    public void Configure(EntityTypeBuilder<Clinic> builder)
    {
        var clinics = new List<Clinic>
        {
            ...
            new()
            {
                ...
                ProfilePictureUrl =
                    "https://res.cloudinary.com/dvadlh7ah/image/upload/v1744178257/ty7jok5ooenrha5aydid.jpg",
                Status = 1,
                TotalBranches = 0,
                IsParent = false,
            ...
            new()
            {
                ...
                ProfilePictureUrl =
                    "https://res.cloudinary.com/dmiueqpah/image/upload/v1744138051/hinh-AA-Clinic-lgo-moi-1-1_smg56o.jpg",
                Status = 1,
                TotalBranches = 0,
                IsParent = false,
                ParentId = new Guid("a96d68d9-3f28-48f3-add5-a74a6b882e93"),
