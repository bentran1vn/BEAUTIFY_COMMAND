...
namespace BEAUTIFY_COMMAND.PERSISTENCE.Migrations
{
    ...
    [Migration("20250422170759_FIxFieldFeedbackId1")]
    partial class FIxFieldFeedbackId1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.ClassificationRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 287, DateTimeKind.Unspecified).AddTicks(1270), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            OptionValue = "A",
                            Points = 2,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 287, DateTimeKind.Unspecified).AddTicks(1280), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            OptionValue = "C",
                            Points = 2,
                            SurveyId = new Guid("f3e2c9f4-9d1b-4d3f-98a6-2a7fabc12345"),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("face2fc5-390c-48dd-b7d4-1d3b1da8a107"),
                            CreatedOnUtc = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("8db805e3-dbf7-47f5-8d9e-5d2343ca77b6"),
                            CreatedOnUtc = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.Survey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 291, DateTimeKind.Unspecified).AddTicks(9310), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.SurveyQuestion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 291, DateTimeKind.Unspecified).AddTicks(9680), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 291, DateTimeKind.Unspecified).AddTicks(9690), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 291, DateTimeKind.Unspecified).AddTicks(9700), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.SurveyQuestionOption", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 292, DateTimeKind.Unspecified).AddTicks(30), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 292, DateTimeKind.Unspecified).AddTicks(40), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 17, 7, 59, 292, DateTimeKind.Unspecified).AddTicks(60), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
