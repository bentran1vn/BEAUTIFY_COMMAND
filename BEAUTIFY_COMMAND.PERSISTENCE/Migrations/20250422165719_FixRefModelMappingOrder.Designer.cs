...
namespace BEAUTIFY_COMMAND.PERSISTENCE.Migrations
{
    ...
    [Migration("20250422165719_FixRefModelMappingOrder")]
    partial class FixRefModelMappingOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.ClassificationRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 502, DateTimeKind.Unspecified).AddTicks(8670), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            OptionValue = "A",
                            Points = 2,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 502, DateTimeKind.Unspecified).AddTicks(8680), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            OptionValue = "B",
                            Points = 2,
                            SurveyId = new Guid("f3e2c9f4-9d1b-4d3f-98a6-2a7fabc12345"),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ec3d15b3-9db3-42b5-8c16-6d99069fe2eb"),
                            CreatedOnUtc = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("f204c503-e850-4aa4-93d0-8e747aa20338"),
                            CreatedOnUtc = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.Survey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 511, DateTimeKind.Unspecified).AddTicks(2540), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.SurveyQuestion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 511, DateTimeKind.Unspecified).AddTicks(2890), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 511, DateTimeKind.Unspecified).AddTicks(2900), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 511, DateTimeKind.Unspecified).AddTicks(2910), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.SurveyQuestionOption", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 511, DateTimeKind.Unspecified).AddTicks(3260), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 511, DateTimeKind.Unspecified).AddTicks(3270), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 22, 16, 57, 18, 511, DateTimeKind.Unspecified).AddTicks(3280), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
