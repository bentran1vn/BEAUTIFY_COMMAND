...
namespace BEAUTIFY_COMMAND.PERSISTENCE.Migrations
{
    ...
    [Migration("20250417073229_IsFirstLoginClinicField")]
    partial class IsFirstLoginClinicField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.ClassificationRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 17, 7, 32, 29, 196, DateTimeKind.Unspecified).AddTicks(6310), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            OptionValue = "A",
                            Points = 2,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 17, 7, 32, 29, 196, DateTimeKind.Unspecified).AddTicks(6320), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            OptionValue = "D",
                            Points = 2,
                            SurveyId = new Guid("f3e2c9f4-9d1b-4d3f-98a6-2a7fabc12345"),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fd1be8ad-9f94-473c-be3a-347b01e2cc02"),
                            CreatedOnUtc = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("e78fb289-abb1-4409-943e-09a0f2e225bd"),
                            CreatedOnUtc = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.Survey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 17, 7, 32, 29, 201, DateTimeKind.Unspecified).AddTicks(7520), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.SurveyQuestion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 17, 7, 32, 29, 201, DateTimeKind.Unspecified).AddTicks(7850), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 17, 7, 32, 29, 201, DateTimeKind.Unspecified).AddTicks(7860), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 17, 7, 32, 29, 201, DateTimeKind.Unspecified).AddTicks(7870), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("BEAUTIFY_COMMAND.DOMAIN.Entities.SurveyQuestionOption", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 17, 7, 32, 29, 201, DateTimeKind.Unspecified).AddTicks(8230), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2025, 4, 17, 7, 32, 29, 201, DateTimeKind.Unspecified).AddTicks(8240), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
