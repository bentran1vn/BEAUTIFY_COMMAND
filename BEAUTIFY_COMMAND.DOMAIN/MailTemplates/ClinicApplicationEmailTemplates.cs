...
<body>
    <div class='header'>
        <h2>Clinic Branch Create Application Update</h2>
    </div>
    <div class='content'>
        <p>Dear {email},</p>
        <p>First of all, our System thanks you for submitting your application!</p>
        ...
        <div class='reason'>
            <p>We regret to inform you that your clinic branch create application does not meet our requirements:</p>
            <p><strong>Reason:</strong> {reason}</p>
        </div>
...
<body>
    <div class='header'>
        <h2>Clinic Branch Create Application Approved</h2>
    </div>
    <div class='content'>
        <p>Dear {email},</p>
        <p>First of all, our System thanks you for submitting your application!</p>
