...
namespace BEAUTIFY_COMMAND.INFRASTRUCTURE.Locking
{
    public interface IDistributedLockService
    {
        ...
        Task<IDisposable> AcquireLockAsync(string key, TimeSpan expiry, TimeSpan waitTime, CancellationToken cancellationToken = default);
        ...
        Task<(bool Acquired, IDisposable LockHandle)> TryAcquireLockAsync(string key, TimeSpan expiry, CancellationToken cancellationToken = default);
    }
}
