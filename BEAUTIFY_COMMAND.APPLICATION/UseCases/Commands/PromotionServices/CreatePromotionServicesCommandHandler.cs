...
public class CreatePromotionServicesCommandHandler : ICommandHandler<CONTRACT.Services.ServicePromotions.Commands.CreatePromotionServicesCommand>
{
    ...
    public CreatePromotionServicesCommandHandler(IRepositoryBase<UserClinic, Guid> userClinicrepository, IRepositoryBase<ClinicService, Guid> clinicServicerepository, IMediaService mediaService, IRepositoryBase<Promotion, Guid> promotionrepository, IRepositoryBase<TriggerOutbox, Guid> triggerOutboxrepository)
    {
    ...
    public async Task<Result> Handle(CONTRACT.Services.ServicePromotions.Commands.CreatePromotionServicesCommand request, CancellationToken cancellationToken)
    {
        ...
        string imageUrl = await _mediaService.UploadImageAsync(request.Image);
