    ...
    CONTRACT.Services.ServicePromotions.Commands.DeletePromotionServicesCommand>
{
    ...
    public DeletePromotionServicesCommandHandler(IRepositoryBase<ClinicService, Guid> clinicServicerepository, IMediaService mediaService, IRepositoryBase<Promotion, Guid> promotionrepository, IRepositoryBase<TriggerOutbox, Guid> triggerOutboxrepository)
    {
    ...
    public async Task<Result> Handle(CONTRACT.Services.ServicePromotions.Commands.DeletePromotionServicesCommand request,
        CancellationToken cancellationToken)
    {
        ...
        if (isValidService == null) return Result.Failure(new Error("401", "Can not delete promotion for this service"));
