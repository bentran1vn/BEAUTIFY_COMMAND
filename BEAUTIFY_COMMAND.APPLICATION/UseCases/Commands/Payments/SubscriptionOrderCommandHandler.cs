...
public class SubscriptionOrderCommandHandler: ICommandHandler<CONTRACT.Services.Payments.Commands.SubscriptionOrderCommand>
{
    ...
    public SubscriptionOrderCommandHandler(IRepositoryBase<Clinic, Guid> clinicRepository, IRepositoryBase<SubscriptionPackage, Guid> subscriptionPackageRepository, IRepositoryBase<SystemTransaction, Guid> systemTransactionRepository)
    {
    ...
    public async Task<Result> Handle(CONTRACT.Services.Payments.Commands.SubscriptionOrderCommand request, CancellationToken cancellationToken)
    {
