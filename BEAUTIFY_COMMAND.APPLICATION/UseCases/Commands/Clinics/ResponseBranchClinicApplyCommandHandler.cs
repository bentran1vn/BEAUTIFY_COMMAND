...
{
    public async Task<Result> Handle(CONTRACT.Services.Clinics.Commands.ResponseClinicBranchApplyCommand request,
        CancellationToken cancellationToken)
    {
        ...
        var clinicMain = await clinicRepository.FindAll(x => x.Id.Equals(applyRequest.Clinic!.ParentId))
