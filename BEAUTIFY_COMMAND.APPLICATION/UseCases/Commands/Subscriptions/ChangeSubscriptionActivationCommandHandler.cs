...
public class ChangeSubscriptionActivationCommandHandler(IRepositoryBase<SubscriptionPackage, Guid> repositoryBase)
    : ICommandHandler<
        CONTRACT.Services.Subscription.Commands.ChangeStatusSubscriptionCommand>
{
    public async Task<Result> Handle(CONTRACT.Services.Subscription.Commands.ChangeStatusSubscriptionCommand request,
        CancellationToken cancellationToken)
    {
        ...
        existingSubscription.IsActivated = !existingSubscription.IsActivated;
