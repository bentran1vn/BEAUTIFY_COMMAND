...
public class ViewFeedbackCommandHandler : ICommandHandler<CONTRACT.Services.Feedbacks.Commands.ViewFeedbackCommand>
{
    ...
    public ViewFeedbackCommandHandler(IRepositoryBase<OrderFeedback, Guid> orderFeedbackRepository,
        IRepositoryBase<TriggerOutbox, Guid> triggerOutboxRepository, IRepositoryBase<Order, Guid> orderRepository)
    {
    ...
    public async Task<Result> Handle(CONTRACT.Services.Feedbacks.Commands.ViewFeedbackCommand request,
